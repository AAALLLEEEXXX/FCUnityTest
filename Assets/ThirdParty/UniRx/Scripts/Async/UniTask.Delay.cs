    ...
    public partial struct UniTask
    {
        ...
        public static UniTask Delay(int millisecondsDelay, bool ignoreTimeScale = false, PlayerLoopTiming delayTiming = PlayerLoopTiming.Update, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            if (!Application.isPlaying)
                return new DelayIgnoreTimeScalePromiseEditor(delayTimeSpan, delayTiming, cancellationToken).Task;
            #endif
        ...
        internal class DelayIgnoreTimeScalePromiseEditor : PlayerLoopReusablePromiseBase
        {
            private readonly double _delayFrameTimeSpan;
            private double _finishTime;
            
            public DelayIgnoreTimeScalePromiseEditor(TimeSpan delayFrameTimeSpan, PlayerLoopTiming timing, CancellationToken cancellationToken)
                : base(timing, cancellationToken, 2)
            {
                _delayFrameTimeSpan = delayFrameTimeSpan.TotalSeconds;
            }


            protected override void OnRunningStart()
            {
                _finishTime = EditorApplication.timeSinceStartup + _delayFrameTimeSpan;
            }
            ...
            public override bool MoveNext()
            {
                ...
                if (EditorApplication.timeSinceStartup >= _finishTime)
                {
                    Complete();
                    TrySetResult();
                    return false;
