...
namespace UniRx
{
    ...
    public interface IReadOnlyReactivePropertyAsync<T> : IReadOnlyReactiveProperty<T>
    {
        #if CSHARP_7_OR_LATER || (UNITY_2018_3_OR_NEWER && (NET_STANDARD_2_0 || NET_4_6))
    ...
    public interface IReactiveProperty<T> : IReadOnlyReactivePropertyAsync<T>
    {
        new T Value { get; set; }
    }
    ...
    public class ReactiveProperty<T> : IReactiveProperty<T>, IDisposable, IOptimizedObservable<T>, IObserverLinkedList<T>
    {
		...
		public void SetValueAndSuppressNotify(T value)
		{
			SetValue(value);
		}
    ...
    public static class ReactivePropertyExtensions
    {
        ...
        public static UniTask<T>.Awaiter GetAwaiter<T>(this IReadOnlyReactivePropertyAsync<T> source)
        {
